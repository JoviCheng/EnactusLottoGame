  ...
  <div class="wrapper">
    <div class="centerCard">
      ...
      <div class="timeTips">
        <div
          class="tipsText"
          v-if="availableTimes>0"
        >您还可以抽取{{availableTimes}}次</div>
        <div
          class="tipsText"
          v-if="availableTimes==0"
        >您的抽奖次数已用完</div>
        <img
          src="../assets/timeTips.png"
          alt=""
          width="70%;"
        >
      </div>
    ...
    >
      <div class="rewardGroup">
        <div class="single">
          <img
            id="reward"
            :src="'../static/reward'+ reward +'.png'"
            alt=""
            width="80%"
          >
          <img
            id="statusIcon"
            :src="'../static/'+received+'.png'"
            alt=""
            width="20%"
          >
        </div>
